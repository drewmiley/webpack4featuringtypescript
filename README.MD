...
```
50. Add `'.ts'` to the extensions array in `webpack.config.js`
51. `npm install typescript awesome-typescript-loader`
...
```
55. Open your browser at `localhost:8080` and gasp in awe.
56. COMMIT
